...
INSERT INTO "XXL_JOB_GROUP"("ID","APP_NAME","TITLE","ADDRESS_TYPE","ADDRESS_LIST","UPDATE_TIME") VALUES(1,'xxl-job-executor-sample','示例执行器',0,null,TO_DATE('2025-03-14 14:58:36','YYYY-MM-DD HH24:MI:SS.FF'));

SET IDENTITY_INSERT "XXL_JOB_GROUP" OFF;
SET IDENTITY_INSERT "XXL_JOB_INFO" ON;
INSERT INTO "XXL_JOB_INFO"("ID","JOB_GROUP","JOB_DESC","ADD_TIME","UPDATE_TIME","AUTHOR","ALARM_EMAIL","SCHEDULE_TYPE","SCHEDULE_CONF","MISFIRE_STRATEGY","EXECUTOR_ROUTE_STRATEGY","EXECUTOR_HANDLER","EXECUTOR_PARAM","EXECUTOR_BLOCK_STRATEGY","EXECUTOR_TIMEOUT","EXECUTOR_FAIL_RETRY_COUNT","GLUE_TYPE","GLUE_SOURCE","GLUE_REMARK","GLUE_UPDATETIME","CHILD_JOBID","TRIGGER_STATUS","TRIGGER_LAST_TIME","TRIGGER_NEXT_TIME") VALUES(1,1,'测试任务1',TO_DATE('2018-11-03 22:21:31','YYYY-MM-DD HH24:MI:SS.FF'),TO_DATE('2018-11-03 22:21:31','YYYY-MM-DD HH24:MI:SS.FF'),'XXL','','CRON','0 0 0 * * ? *','DO_NOTHING','FIRST','demoJobHandler','','SERIAL_EXECUTION',0,0,'BEAN','','GLUE代码初始化',TO_DATE('2018-11-03 22:21:31','YYYY-MM-DD HH24:MI:SS.FF'),'',0,0,0);
